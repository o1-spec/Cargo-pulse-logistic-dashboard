    ...
    <div className="flex items-center gap-10 py-4 px-8 bg-[#f7f7f7] dark:bg-[#1a1a1a] fixed top-0 left-[17%] right-0 z-50">
      <div className="relative basis-[85%]">
        ...
        <input
          type="text"
          placeholder="Search..."
          className="border-[0.6px] border-gray-300 dark:border-gray-600 py-1.5 px-1 pl-10 w-full rounded-md outline-none bg-white dark:bg-[#2c2c2c] text-gray-800 dark:text-white"
        />
      </div>
